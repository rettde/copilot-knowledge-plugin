...
- Any data context files referenced in the project's `.github/copilot-instructions.md`
- Check freshness of any data files cited

### Step 2: Run both reviewers

Run both review perspectives simultaneously:

**1. Strategic Alignment Review** — Follow the instructions in `#review-strategic-alignment`:
- Pass: the full content + any business context from the project's `.github/copilot-instructions.md`
...
**2. Data Accuracy Review** — Follow the instructions in `#review-data-accuracy`:
- Pass: the full content + any data context files referenced in the project's `.github/copilot-instructions.md`
- It checks: source citations, comparison baselines, canonical definitions, freshness, caveats, hardcoded numbers

Both perspectives produce findings in `[P1|P2|P3]` format.
