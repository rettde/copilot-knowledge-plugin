---
description: "Verify that numbers, metrics, and data claims in knowledge work artifacts are accurate, sourced, and fresh. Checks that every number has a cited source, comparison baselines are explicit, and data matches canonical definitions."
---
...
3. **Canonical Definitions** — Do the numbers match canonical definitions? If the project has a data context file (referenced in `.github/copilot-instructions.md`), check that metrics use the right source of truth.
...
2. **Load data context.** Check the project's `.github/copilot-instructions.md` for data source hierarchy and canonical definitions. Read any referenced data context files.
