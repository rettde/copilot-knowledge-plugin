---
description: "Review knowledge work artifacts for strategic alignment. Checks whether goals are explicit, hypotheses are falsifiable, success metrics are measurable, scope is proportional to impact, and the work serves stated objectives."
---
...
6. **Strategic Consistency** — Is this consistent with stated company or team goals? Check the project's `.github/copilot-instructions.md` for business context if available.
...
2. **Load context** — Read the project's `.github/copilot-instructions.md`, check `plans/` for recent plans, check `docs/knowledge/` for past strategic learnings.
