...
Each action must be specific enough to execute immediately. "Read `data/q4-results.csv` to confirm the $50K benchmark" not "gather more data." Note which actions you can do autonomously vs. which need user input.
